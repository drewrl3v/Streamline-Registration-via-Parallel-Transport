...
tract1, tract2 = two_cingulum_bundles()
tract1 = set_number_of_points(tract1, nb_points=100)
tract2 = set_number_of_points(tract2, nb_points=100)
tract1 = tract1[:113]
tract2 = tract2[:113] 
tract1 = np.array(tract1)
tract2 = np.array(tract2)
tract1 = tract1.transpose((0,2,1))
tract2 = tract2.transpose((0,2,1))
